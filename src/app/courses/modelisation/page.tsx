      ...
      <div className="w-full max-w-3xl">
        ...
        <section className="mb-10">
          ...
          <ul className="space-y-3 pl-4">
            <li>
              <Link
                href="/courses/modelisation/algoRecherche"
            ...
            <li>
              <Link
                href="/courses/modelisation/heuristique"
                className="text-blue-600 hover:text-blue-800 transition-colors"
              >
                Les heuristiques
              </Link>
            ...
            <li>
              <Link
                href="/courses/modelisation/minimax"
                className="text-blue-600 hover:text-blue-800 transition-colors"
              >
                Minimax
              </Link>
            ...
            <li>
              <Link
                href="/courses/modelisation/regressionLineaire"
                className="text-blue-600 hover:text-blue-800 transition-colors"
              >
                Régression linéaire
              </Link>
            ...
            <li>
              <Link
                href="/courses/modelisation/annexe"
                className="text-blue-600 hover:text-blue-800 transition-colors"
              >
                Annexe
              </Link>
